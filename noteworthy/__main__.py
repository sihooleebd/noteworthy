...
def main():
    ...
    parser.add_argument('--headless', action='store_true', help='Do not launch browser after startup')
    ...
    if args.gui:
        try:
            if args.no_coop:
                ...
                run_gui(host=args.bind, port=args.port, packet_log=args.packet_log, open_browser=(not args.headless))
