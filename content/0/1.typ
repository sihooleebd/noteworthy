...
= . 1월 12 일 신년 연말결산
- 에디터 관련 업데이트
  - bull list num list 줄 추가할때 자동생성. Delete 하면 자동삭제
  - bull list num list tab 하면 indente. shift tab 하면 unindente.
  - vim keys(미정)
  - \$ autocomplete
  - contextual autocomplete
  - SYNC BUG FIX - 동시에수정할때

허허허 이거 sync허버기하네요한번만 치면 문제가 없는데
하하핳하하더재댜러재ㅑ더래쟈덜
덜무
아 샤갈 어떻게 해야하지
글자별로 websocket을 열어야 하나

무

서버 측 로그를 봐야겠는데? 원래 crdt가 이론상으론 순서가 뒤바껴 들어가도 같은 결과를 내야 하잖아.

보면 결론적으로는 어떻게든 문제가 안 생기는 듯 하긴 한데 결국 뭐가 문젠거지..?


러러ㅓ재러재댜러ㅐ쟈더래쟈더래쟈더래쟈더래쟈더래쟈더래쟈덜 oiwjefoijwefoiwjeoiwjefoiwjefoijwefoijwefoijwefoijwef
나 혼자 칠때는 아무런 문제가 없고

내가 이렇게 개지랄 하고 있으면 님 눈에는 이상하게 보임? 결국 싱크가 완전히 망가지진 않는 거 보면 글자 입력이 결국 다 전달되긴 한단 말이지...


음 iejfjeifjeifjeㅐㅑi???? ㅈㅁ
- ㅈ대ㅑ러

재ㅐ쟈ㅐㅑ저ㅐㅑ저ㅐㅁ낭러ㅣ나어ㅣㅏㄴ어리ㅏ너이라ㅓㄴㅇㄹ나어란어란어ㅏㄴㅇ쟈ㅐ쟈대쟈ㅐ쟈ㅐ쟈ㅐ쟈ㅐ쟈재댜ㅐ쟈ㅐ쟈ㅐ쟈재이쟈버ㅐ버그가 ㅣ
$$요거도 되고
- 아ㅇㅇ 그러니까 minor improvementsㅓ아
래ㅇ냐ㅗ아예 ㅇ

아까도 뭔가 ㅈㄹ났네 ㅐ쟈더재대재쟈재재ㅐ쟈재재ㅐ쟈ㅐㅐㅐㅐㅐㅐㅐㅑㅐㅐㅐㅐㅑㅐㅐㅐㅐㅑㅐㅐㅐㅐㅑㅐㅐㅐㅑㅐㅐㅐㅐㅑ ㅋㅋㅋㅋㅋ

ㅁㄴㅇㄹ
ㅐ
ㅇ리마어라어아어아어아러니아런아러니닝ㅇ니 아니대체도체독스는글는뭔 ㅁ흑ㅁ뭔마을을부린임거이asdfㅁㄴㅇㄹㅁㄴㅇㄹㅁㄴㅇㄹ
없진 않은데 훨씬 낫네그.근나 데지 금님  커서 위치랑 글씨 써지는 데랑 전혀 다름 ㅋㅋ.그ㅇ. ㅋㅋㅋㅋ.ㅋ.ㅋ버그버그레츠고
- 재댜러허는 되는허허허가제느이ㅏ
허허허 허허허 되는건가 허허 음너도 타이핑 해보셈럴하아러라ㅣㅏ너댜ㅐ히ㅏ너댜러ㅗㅑㄷ허ㅏㄷ호럳러댜ㅓ다댜호다
